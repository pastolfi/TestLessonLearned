sap.ui.define([
	...
	return BaseObject.extend("com.sap.build.standard.llMd.model.ListSelector", {
		 ...
		 * @class
		 * @public
		 * @alias com.sap.build.standard.llMd.model.ListSelector
		 */
		 ...
		 * @return {com.sap.build.standard.llMd.model.ListSelector} the list selector object for method chaining
		 * @public
		 */
